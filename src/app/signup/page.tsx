...
function SignupForm() {
  ...
  return (
    <main className="flex items-center h-[100vh] bg-black">
        <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl border-2 p-4 md:p-8 shadow-input bg-white dark:bg-black">
          ...
          <form className="my-8" onSubmit={handleSubmit}>
            ...
            <p>Already have an account? <Link href='/login'>Click here</Link> to log in</p>
